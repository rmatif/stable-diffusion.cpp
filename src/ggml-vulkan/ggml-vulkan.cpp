...
static void ggml_vk_load_shaders(vk_device& device) {
    ...
    if (device->coopmat2) {
        ...
        m_warptile = { 64,  32,  32, 16, subgroup_size_8, 16, 2, tm_m, tn_m, tk_m, subgroup_size_8 };
        s_warptile = { subgroup_size_16, 16, 16, 16, 32, 16, 2, tm_s, tn_s, tk_s, subgroup_size_8 };

        l_warptile_mmq = { 128, 128, 128, 32, subgroup_size_8 * 2, 64, 2, tm_l, tn_l, tk_l, subgroup_size_8 };
        m_warptile_mmq = { 64,  32,  32, 32, subgroup_size_8, 16, 2, tm_m, tn_m, tk_m, subgroup_size_8 };
        s_warptile_mmq = { subgroup_size_32, 16, 16, 32, 32, 16, 2, tm_s, tn_s, tk_s, subgroup_size_8 };
