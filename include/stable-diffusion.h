...
enum sd_model_version_t {
    ...
    SD_MODEL_VERSION_SDXS            = 7,
    SD_MODEL_VERSION_SDXL            = 8,
    SD_MODEL_VERSION_SDXL_INPAINT    = 9,
    SD_MODEL_VERSION_SDXL_PIX2PIX    = 10,
    SD_MODEL_VERSION_SDXL_VEGA       = 11,
    SD_MODEL_VERSION_SDXL_SSD1B      = 12,
    SD_MODEL_VERSION_SVD             = 13,
    SD_MODEL_VERSION_SD3             = 14,
    SD_MODEL_VERSION_FLUX            = 15,
    SD_MODEL_VERSION_FLUX_FILL       = 16,
    SD_MODEL_VERSION_FLUX_CONTROLS   = 17,
    SD_MODEL_VERSION_FLEX_2          = 18,
    SD_MODEL_VERSION_CHROMA_RADIANCE = 19,
    SD_MODEL_VERSION_WAN2            = 20,
    SD_MODEL_VERSION_WAN2_2_I2V      = 21,
    SD_MODEL_VERSION_WAN2_2_TI2V     = 22,
    SD_MODEL_VERSION_QWEN_IMAGE      = 23,
    SD_MODEL_VERSION_ANIMA           = 24,
    SD_MODEL_VERSION_FLUX2           = 25,
    SD_MODEL_VERSION_FLUX2_KLEIN     = 26,
    SD_MODEL_VERSION_Z_IMAGE         = 27,
    SD_MODEL_VERSION_OVIS_IMAGE      = 28,
    SD_MODEL_VERSION_COUNT           = 29,
};
