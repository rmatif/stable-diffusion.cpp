...
enum sd_model_version_t {
    ...
    SD_MODEL_VERSION_SDXL_SSD1B      = 11,
    SD_MODEL_VERSION_SVD             = 12,
    SD_MODEL_VERSION_SD3             = 13,
    SD_MODEL_VERSION_FLUX            = 14,
    SD_MODEL_VERSION_FLUX_FILL       = 15,
    SD_MODEL_VERSION_FLUX_CONTROLS   = 16,
    SD_MODEL_VERSION_FLEX_2          = 17,
    SD_MODEL_VERSION_CHROMA_RADIANCE = 18,
    SD_MODEL_VERSION_WAN2            = 19,
    SD_MODEL_VERSION_WAN2_2_I2V      = 20,
    SD_MODEL_VERSION_WAN2_2_TI2V     = 21,
    SD_MODEL_VERSION_QWEN_IMAGE      = 22,
    SD_MODEL_VERSION_FLUX2           = 23,
    SD_MODEL_VERSION_FLUX2_KLEIN     = 24,
    SD_MODEL_VERSION_Z_IMAGE         = 25,
    SD_MODEL_VERSION_OVIS_IMAGE      = 26,
    SD_MODEL_VERSION_COUNT           = 27,
};
